...
Private Sub UserControl_Paint()
    ...
    Else
        ...
        With m_cUxTheme
            ...
            .TextOffset = 32
            .RightTextOffset = 30
            .TextAlign = DT_right Or DT_VCENTER Or DT_SINGLELINE Or DT_WORD_ELLIPSIS
            Select Case sColorName
            ...
            If m_bDetailsGroup Then
                ...
                If m_DetailsGroup.bExpanded Then
                    ...
                    If m_DetailsPicture Is Nothing Then
                        ...
                        DrawText UserControl.hdc, m_DetailsGroupTittle, -1, tmpRect, DT_right Or DT_WORDBREAK
                        'DrawText
                        UserControl.FontBold = False
                        DrawText UserControl.hdc, m_DetailsGroupText, -1, m_DetailsRect, DT_right Or DT_WORDBREAK 'Len(m_DetailsGroupText)
...
Private Function DrawRectText(rtRect As RECT, sText As String) As Long
    ...
    DrawText UserControl.hdc, sText, Len(sText), rtRect, DT_WORDBREAK
    'Redraw Window
